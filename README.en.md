...
Shopping flow: search → select a product → convert its product_ref. Search returns estimated member rewards without promotion links. Conversion results are reused per member for ten minutes; product references last 24 hours.
